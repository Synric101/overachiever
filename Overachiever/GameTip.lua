...
function Overachiever.GetDifficulty()
  ...
  if (inInstance) then
-- IF IN AN INSTANCE:
  -- Returns: <instance type ("pvp"/"arena"/"party"/"raid")>, <Heroic?>, <Challenge?>, <Mythic?>, <25-player Raid?>, <Flex Raid?>, <Mythic Raid?> <Dynamic?>
  ...
  --   way to make the return values consistent with those given when you're NOT in an instance.
    ...
    local _, _, isHeroic, isChallengeMode = GetDifficultyInfo(diff) -- This function can also give us isChallengeMode, but we're not using it at the moment.
    return itype, (diff == 1), (diff == 5 or diff == 6 or diff == 15), isHeroic, isChallengeMode, (diff == 23), (diff == 4 or diff == 6), (diff == 14 or diff == 15), (diff == 16), (diff == 17), isDynamic
  end
-- IF NOT IN AN INSTANCE:
  -- Returns: false, <Dungeon set as Heroic?>, <Challenge Mode?>, <Mythic Dungeon?>, <Raid set for 25 players?>, <Raid set as Heroic?>, <Flex Raid?>, <Mythic Raid?>
  local d = GetDungeonDifficultyID()
  local r = GetRaidDifficultyID()
  local l = GetLegacyRaidDifficultyID()
  return false, (d == 1), (d == 2), (l > 4), (d == 8), (d == 23), (l == 4 or l == 6), (r == 14 or r == 15), (r == 16), (r == 17)
end
